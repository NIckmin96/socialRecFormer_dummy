    ...
    def forward(self, Q, K, V, mask=None, attn_bias=None, last_layer_flag=False, is_dec_layer=False):
        ...
        if attn_bias is not None:
            ...
            if is_dec_layer: 
                ...
                loss = F.binary_cross_entropy_with_logits(score.float(), attn_bias.float())
                ...
                loss = torch.sqrt(F.mse_loss(score.float(), attn_bias.float())) # [TODO] MSE loss에 대해서 다시 sqrt를 취하고, element의 개수로 나눠서 loss를 계산하는게 맞는지?
