...
class Decoder(nn.Module):
    ...
    """
    def __init__(self, num_user, num_item, max_degree, d_model, d_ffn, num_heads, dropout, num_layers, n_experts, topk, args):
        """
        Args:
    ...
    def forward(self, batched_data, enc_output, is_train):
        ...
        del dec_self_attn_mask, dec_enc_mask, attn_bias

        return output, sum(losses)/len(losses)