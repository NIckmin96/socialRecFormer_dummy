...
class Transformer(nn.Module):
    ...
    def __init__(self, num_user, max_degree_user, max_spd_value, num_item, max_degree_item, d_model, d_ffn, num_heads, dropout, num_layers_enc, num_layers_dec, n_experts, topk, args):
