...
def generate_social_random_walk_sequence(data_path:str, rating_split:pd.DataFrame, social_split:pd.DataFrame, walk_length:int=5, data_split_seed:int=42, split:str='train', regenerate:bool=False):
...
def generate_input_sequence_data(data_path, user_df:pd.DataFrame, rating_df:pd.DataFrame, seed:int, split:str, random_walk_len:int=30, item_per_user:int=5, regenerate:bool=False, used_pairs:dict={}):
