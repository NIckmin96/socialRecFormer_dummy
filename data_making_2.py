...
class DatasetMaking:
    def __init__(self, args):
        ...
        # self.rating_train, self.rating_test = utils.shuffle_and_split_dataset(data_path, test=args.test_ratio, seed=args.seed, regenerate=args.regenerate)
        ...
        self.total_train, self.used_pairs = utils.generate_input_sequence_data(data_path=data_path, user_df=self.random_walk_train, rating_df=self.rating_df, seed=args.seed,
                                                                              split='train', random_walk_len=args.user_seq_len, item_per_user=args.item_per_user,  regenerate=args.regenerate)
        ...
        self.total_test, _ = utils.generate_input_sequence_data(data_path=data_path, user_df=self.random_walk_test, rating_df=self.rating_df, seed=args.seed,
                                                                              split='test', random_walk_len=args.user_seq_len, item_per_user=args.item_per_user,  regenerate=args.regenerate, used_pairs=self.used_pairs)
