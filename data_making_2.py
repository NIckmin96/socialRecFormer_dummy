...
class DatasetMaking:
    def __init__(self, args):
        ...
        self.rating_train, self.rating_test = utils.shuffle_and_split_dataset(data_path, df_len=self.rating_df.shape[0], test=args.test_ratio, seed=args.seed, regen=args.regen)
