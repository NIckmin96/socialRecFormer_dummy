...
class DatasetMaking:
    def __init__(self, dataset, seed, user_seq_len, item_per_user, return_params, train_augs, test_augs, rating_thres, regenerate):
        # self.args = args
        ...
        # self.ranking_test = utils.generate_ranking_test_data(data_path=data_path, rating_test=self.rating_test, item_degree_test=self.item_degree_test, user_item_train=self.user_item_table_train, user_item_test=self.user_item_table_test, user_degree_df=self.user_degree_test, seed=seed, user_seq_len=user_seq_len, item_per_user=item_per_user, rating_thres=rating_thres, regenerate=regenerate)
