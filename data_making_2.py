...
class DatasetMaking:
    def __init__(self, args):
        ...
        # User Degree Table
        self.user_degree_train, max_user_degree_train = utils.generate_user_degree_table(data_path, self.social_train, split='train', seed=args.seed, regenerate=args.regenerate)
        self.user_degree_valid, max_user_degree_valid = utils.generate_user_degree_table(data_path, self.social_valid, split='valid', seed=args.seed, regenerate=args.regenerate)
        self.user_degree_test, max_user_degree_test = utils.generate_user_degree_table(data_path, self.social_test, split='test', seed=args.seed, regenerate=args.regenerate)
        ...
        # Item Degree Table
        self.item_degree_train, max_item_degree_train = utils.generate_item_degree_table(data_path, self.rating_train, split='train', seed=args.seed, regenerate=args.regenerate)
        self.item_degree_valid, max_item_degree_valid = utils.generate_item_degree_table(data_path, self.rating_valid, split='valid', seed=args.seed, regenerate=args.regenerate)
        self.item_degree_test, max_item_degree_test = utils.generate_item_degree_table(data_path, self.rating_test, split='test', seed=args.seed, regenerate=args.regenerate)
        ...
        self.user_item_table_train = utils.generate_interacted_items_table(data_path, self.rating_train, self.item_degree_train, split='train', seed=args.seed, regenerate=args.regenerate)
        self.user_item_table_valid = utils.generate_interacted_items_table(data_path, self.rating_valid, self.item_degree_valid, split='valid', seed=args.seed, regenerate=args.regenerate)
        self.user_item_table_test = utils.generate_interacted_items_table(data_path, self.rating_test, self.item_degree_test, split='test', seed=args.seed, regenerate=args.regenerate)
        ...
        self.total_test, self.test_user_item = utils.generate_input_sequence_data(data_path=data_path, user_df=self.random_walk_test, item_df=self.user_item_table_test,
                                                                                    ...
                                                                                    return_params=args.return_params, train_augs=args.train_augs, test_augs=args.test_augs, regenerate=args.regenerate)
        ...
        self.total_train = utils.generate_input_sequence_data(data_path=data_path, user_df=self.random_walk_train, item_df=self.user_item_table_train,
                                                                seed=args.seed, split='train', random_walk_len=args.user_seq_len, item_per_user=args.item_per_user,
                                                                 return_params=args.return_params, train_augs=args.train_augs, test_augs=args.test_augs, rating_thres=args.rating_thres,
                                                                  regenerate=args.regenerate, test_user_item=self.user_item_dic)
